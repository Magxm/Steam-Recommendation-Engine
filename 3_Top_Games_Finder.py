...
def data_discovery_games(games_file, recommendations_file, criteria):
...
while True:
    user_criteria = input(
        "Choose one of the criteria: 'Positive Ratio', or 'Number of Positive Reviews' or type 'exit' to exit: "
    )
